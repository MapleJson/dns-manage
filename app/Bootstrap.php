...
class Bootstrap extends Paginator
{
    ...
    {
        return '<li class="paginate_button page-item disabled"><span class="page-link">' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="paginate_button page-item active"><span class="page-link">' . $text . '</span></li>';
    }
